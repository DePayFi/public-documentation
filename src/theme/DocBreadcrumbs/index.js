...
export default function DocBreadcrumbs() {
  ...
  if(mainNavigation) {
    ...
    mainNavigation = mainNavigation.split("");
    mainNavigation[0] = mainNavigation[0].toUpperCase();
    mainNavigation = mainNavigation.join('');
    breadcrumbs.unshift({
      href: `/docs/${mainNavigation.toLowerCase()}/`,
