...
The CEO's primary responsibilities include making major corporate decisions, managing the overall operations and resources of a company, and being the public face of the company.
...
*   Ensures and evolves the company's core values

### Chief Technology Officer (CTO)

The CTO makes all executive decisions with regards to the technological interests of a company.
...
*   Seeding and cultivating the companies engineering and technology culture
*   Enable and empower every single employee to perform their job and tasks as best as possible with technology

### Chief Financial Officer (CFO)

The typical traits of a CFO are integrity and transparency. 

The CFO is responsible for managing the financial decisions of the company.
...
*   Answer questions
*   Forward questions, if you can't answer them yourself
*   Diffuse toxic behaviors (like FUD, Spam, etc.) first with intervening, second with deleting posts and banning
*   Spread constant micro information in the channel (like daily) with facts about DePay (e.g. "Did you know DePay's current circulating supply is X DEPAY?")
*   Have fun, as being part of a community means also sometimes chatting about fun and stupid things
